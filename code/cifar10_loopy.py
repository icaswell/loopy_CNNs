...
X_train, y_train, X_val, y_val, X_test, y_test = \
	load_cifar10(num_training=49000, num_validation=1000, num_test=1)

print X_train.shape, y_train.shape
print X_val.shape, y_val.shape

history = model.train_model(X_train, y_train, X_test, y_test, n_epochs=5, use_expensive_stats=True)
