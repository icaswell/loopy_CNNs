...
model = LoopyNetwork(architecture_fpath="../architectures/mnist_c3_c3_c1_fc+loop.py", n_unrolls=3, batch_size=36)
print repr(model)
...
history = model.train_model(X_train, y_train, X_test, y_test, n_epochs=20, use_expensive_stats=True, check_error_n_batches=check_error_n_batches)
print history
