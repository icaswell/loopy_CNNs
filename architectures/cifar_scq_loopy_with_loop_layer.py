...
"layers": #parser asserts that there exists a layer called "input" and a layer called "output"
        ...
        "conv_1":{"num_filters":48, "template": "conv3"},
        "conv_2":{"num_filters":48, "template": "conv3"},
        "conv_3":{"num_filters":48, "template": "conv3"},
        "conv_4":{"num_filters":48, "template": "conv3"},
        "conv_5":{"num_filters":3, "template": "conv3"},
        "loop_layer":{"num_filters":3, "template": "conv3"},
...
"stacks":
        ...
        "main_stack": {
                "type": "main",
                "structure": ["input", "conv_1", "conv_2", "conv_3", "conv_4", "conv_5", "fc_1"]
                },
         "loop": {
                "type": "loop",
                "structure": ["conv_5", "loop_layer", "conv_1"],
